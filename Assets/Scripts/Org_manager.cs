...
public class Org_manager : MonoBehaviour
{
    ...
    public void Deploy()
    {
        Aircraft ac1 = new Aircraft("天山", "近藤狂四郎", 100, 100, false, false);
        Aircraft ac2 = new Aircraft("天山", "磐田禅師", 100, 100, false, false);
        Aircraft ac3 = new Aircraft("天山", "アナルシコ太郎", 100, 100, false, false);
